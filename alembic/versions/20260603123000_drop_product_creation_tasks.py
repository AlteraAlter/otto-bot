"""drop product creation task history

Revision ID: 20260603123000
Revises: 20260603110000
...
revision = "20260603123000"
down_revision = "20260603110000"
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.execute("DROP TABLE IF EXISTS product_creation_task_items")
    op.execute("DROP TABLE IF EXISTS product_creation_tasks")
