"""add OTTO XLSX name mappings table

Revision ID: 20260721160000
Revises: 20260721150000
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("source_ean", sa.String(), nullable=True),
        ...
        sa.Column("source_normalized_name", sa.Text(), nullable=False),
        sa.Column("target_normalized_name", sa.Text(), nullable=False),
    ...
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_source_account"),
        "otto_xlsx_name_mappings",
        ["source_account"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_target_account"),
        "otto_xlsx_name_mappings",
        ["target_account"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_source_import_row_id"),
        "otto_xlsx_name_mappings",
        ["source_import_row_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_target_import_row_id"),
        "otto_xlsx_name_mappings",
        ["target_import_row_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_source_ean"),
        "otto_xlsx_name_mappings",
        ["source_ean"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_target_ean"),
        "otto_xlsx_name_mappings",
        ["target_ean"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_source_normalized_name"),
        "otto_xlsx_name_mappings",
        ["source_normalized_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_otto_xlsx_name_mappings_target_normalized_name"),
        "otto_xlsx_name_mappings",
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_otto_xlsx_name_mappings_target_normalized_name"),
        table_name="otto_xlsx_name_mappings",
    )
    op.drop_index(
        op.f("ix_otto_xlsx_name_mappings_source_normalized_name"),
        table_name="otto_xlsx_name_mappings",
    ...
    op.drop_table("otto_xlsx_name_mappings")
